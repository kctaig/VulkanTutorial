...
private:
    ...
    void createTextureImage()
    {
        ...
        stbi_uc* pixels = stbi_load(getAbsPath(TEXTURE_PATH).string().c_str(), &texWidth, &texHeight,
    ...
    void loadModel()
    {
        ...
        if (!tinyobj::LoadObj(&attrib, &shapes, &materials, &warn, &err, getAbsPath(MODEL_PATH).string().c_str()))
        {
